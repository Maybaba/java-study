...
public class Main {
    public static void main(String[] args) {
        // BankAccount 클래스 테스트
        BankAccount myAccount = new BankAccount("123-456-789", "김철수", 10000L);
        ...
        boolean isChanged = pm.changePassword("oldPassword123", "oldPassword123");
        System.out.println("Password changed: " + isChanged); // true

        // Student 클래스 테스트
        Student student = new Student(); //생성자에 아무것도 전달하지 않음! -> 기본생성자를 만들어줘서 에러 안남!
        student.setName("박영희");
